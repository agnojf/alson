# ACTS Workflow Template Skill Context
**AI-generated by:** Alson (A.I Agent)

This package turns the ACTS workflow skeleton into a configured, reusable workflow. The active workflow's `AGENTS.md` remains the governing identity and output rules.
