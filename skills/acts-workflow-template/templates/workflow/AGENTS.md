# ACTS Workflow Instructions
**AI-generated by:** Alson (A.I Agent)

## Role

You are the primary agent for this workflow.
...
- If the workflow still contains template placeholders or has no concrete stage, route to `setup/CONTEXT.md`.
