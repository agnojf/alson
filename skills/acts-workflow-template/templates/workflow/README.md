...
A reusable, vendor-neutral workflow skeleton for AI-assisted work.

## Purpose

Use this template to create a new workflow without redesigning the context architecture each time.
...
This is the main unit of composition in the workflow.
...
| Unix idea | Workflow implementation |
|---|---|
