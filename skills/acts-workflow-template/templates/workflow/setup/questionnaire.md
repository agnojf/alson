# Workflow Setup Questionnaire
**AI-generated by:** Alson (A.I Agent)

Answer these before finalizing a new workflow.

## 1. Outcome

What outcome should this workflow help the user achieve repeatedly?
...
Are inputs copied into the workflow or referenced externally?
...
What is the minimum passing quality percentage? Use 80% unless this workflow needs a higher threshold.
